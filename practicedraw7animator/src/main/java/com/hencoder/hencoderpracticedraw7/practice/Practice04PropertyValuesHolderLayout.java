...
/**
 * FileName: Practice04PropertyValuesHolderLayout
 * Author: nanzong
 * Date: 2019/5/6 3:08 PM
 * Description:
 * History:
 */
public class Practice04PropertyValuesHolderLayout extends RelativeLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        animatorBt = findViewById(R.id.animateBt);

        animatorBt.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                //然后用ObjectAnimator.ofPropertyValuesHolder()把三个属性合并，并创建 Animator 然后执行
