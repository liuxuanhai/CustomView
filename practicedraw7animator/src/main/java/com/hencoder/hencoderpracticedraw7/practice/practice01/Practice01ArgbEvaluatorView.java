...
/**
 * FileName: Practice01ArgbEvaluatorView
 * Author: nanzong
 * Date: 2019/5/6 11:41 AM
 * Description:
 * History:
 */
public class Practice01ArgbEvaluatorView extends View {
    ...
    public Practice01ArgbEvaluatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Practice01ArgbEvaluatorView(Context context, AttributeSet attrs, int defStyleAttr) {
