...
/**
 * FileName: Practice06KeyframeView
 * Author: nanzong
 * Date: 2019/5/6 5:35 PM
 * Description:
 * History:
 */
public class Practice06KeyframeView extends View {
    ...
    public Practice06KeyframeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Practice06KeyframeView(Context context, AttributeSet attrs, int defStyleAttr) {
