...
/**
 * FileName: Practice08ObjectAnimatorView
 * Author: nanzong
 * Date: 2019/5/6 11:05 AM
 * Description:
 * History:
 */
public class Practice08ObjectAnimatorView extends View {
    ...
    public Practice08ObjectAnimatorView(Context context,AttributeSet attrs) {
        super(context, attrs);
    }

    public Practice08ObjectAnimatorView(Context context, AttributeSet attrs, int defStyleAttr) {
