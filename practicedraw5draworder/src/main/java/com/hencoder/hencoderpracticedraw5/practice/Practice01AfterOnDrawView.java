...
/**
 * FileName: Practice01AfterOnDrawView
 * Author: nanzong
 * Date: 2019/4/24 5:32 PM
...
public class Practice01AfterOnDrawView extends AppCompatImageView {
    ...
    public Practice01AfterOnDrawView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Practice01AfterOnDrawView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        //在 super.onDraw()下方插入绘制代码，让绘制的内容盖住原主体内容
        //由于这期重点是绘制代码位置而不是绘制代码本身，所以直接给出绘制代码，你只要解除注释就好
